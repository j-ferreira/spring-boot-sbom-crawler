...
public interface DependencyTrackFeignClient {
    ...
    @GetMapping(value = "/api/v1/finding/project/{uuid}", consumes = "application/sarif+json")
    String getFindings(@PathVariable String uuid, @RequestHeader("Authorization") String bearerToken, @RequestParam("suppressed") Boolean suppressed);
